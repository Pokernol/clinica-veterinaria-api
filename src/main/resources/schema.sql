...
CREATE TABLE Consultas (
                           ...
                           prescricaoId INT, -- Esta coluna precisa existir para que a FK possa ser adicionada depois
...
ALTER TABLE Consultas
    ADD CONSTRAINT FK_ConsultaPrescricao
        FOREIGN KEY (prescricaoId) REFERENCES Prescricoes(id);